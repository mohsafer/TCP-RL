...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("transport_prot", "Transport protocol to use: TcpNewReno, "
                ...
                "TcpBic, TcpYeah, TcpIllinois, TcpWestwoodPlus, TcpWestwoodPlusPlus, TcpLedbat, "
  ...
  // Select TCP variant
  if (transport_prot.compare ("ns3::TcpWestwoodPlusPlus") == 0)
    {
      // TcpWestwoodPlusPlus is not an actual TypeId name; we need TcpWestwoodPlus here
      Config::SetDefault ("ns3::TcpL4Protocol::SocketType", TypeIdValue (TcpWestwoodPlus::GetTypeId ()));
      // the default protocol type in ns3::TcpWestwoodPlus is WESTWOOD
